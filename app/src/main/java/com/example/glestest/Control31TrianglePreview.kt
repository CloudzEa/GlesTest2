...
class Control31TrianglePreview {
    ...
    fun init(): ProbeResult {
        val vertexSource = "#version 310 es\nlayout(location = 0) in vec2 aPos;\nvoid main(){ gl_Position = vec4(aPos, 0.0, 1.0); }"
        val fragmentSource = "#version 310 es\nprecision mediump float;\nout vec4 outColor;\nvoid main(){ outColor = vec4(0.10, 0.85, 0.95, 1.0); }"
        ...
        return ProbeResult(
            ...
            detail = "control #version 310 es triangle pipeline initialized"
        )
    }
